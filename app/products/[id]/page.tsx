        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-4 pb-6 border-b border-gray-200">
              ...
              {product.stock > 0 ? (
                <span className="flex items-center gap-2 text-green-600 bg-green-50 px-4 py-2 rounded-full text-sm font-semibold">
                  <Package size={16} />
                  En Stock ({product.stock})
                </span>
              ) : (
                <span className="flex items-center gap-2 text-red-600 bg-red-50 px-4 py-2 rounded-full text-sm font-semibold">
                  <Package size={16} />
                  Agotado
                </span>
              )}
            ...
            <div className="grid grid-cols-1 gap-4 pt-6 border-t border-gray-200">
              ...
              <div className="flex items-start gap-4 p-4 bg-pink-50 rounded-xl">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Frescura Garantizada</h4>
                  <p className="text-sm text-gray-600">Flores frescas directamente del cultivador</p>
                </div>
              </div>
            </div>
          </div>
