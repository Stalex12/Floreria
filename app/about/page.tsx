        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-gray-700 text-lg leading-relaxed">
              <p>
                Fundada en <span className="font-semibold text-purple-600">2024</span>, Mundo Eterno es un emprendimiento creado por Kelly Cartagena Miranda el 27 de octubre de 2024, surge después de que descubriera en internet publicaciones de arreglos florales y elementos decorativos en material aterciopelado. Fascinada por estas creaciones, decidió realizar arañas con dulces para Halloween en la Plazuela Mariscal Antonio José de Sucre, debido al éxito de la venta, decide lanzar su propio negocio de todo tipo de flores a elección del cliente.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 pt-8">
              <div className="text-center p-4 bg-purple-50 rounded-xl">
                ...
                <p className="text-sm text-gray-600">Año de experiencia</p>
              </div>
